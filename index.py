...
#====== Parte onde instânciamos o nosso projecto e fazemos a ingestão =======#
...
app.layout = html.Div(children=[
    dbc.Row([
        dbc.Col([
            dbc.Card([
                html.H2('TCHUZER', style={'font-family':'Voltaire','font-size':'50px'}),
                html.Hr(),
...
def render_graphs(cities, main_variable):
    ...
    for fig in [fig_city, fig_payment, fig_gender, fig_income_date]:
        fig.update_layout(margin=dict(l=0, r=0, t=10,b=10), height=200, template='minty')
